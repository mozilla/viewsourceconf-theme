      ...
      <nav class="navigation posts-navigation" role="navigation">
        ...
        <div class="nav-links">
          ...
          <?php if ( get_next_posts_link () ) : ?>
            <div class="nav-previous"><?php next_posts_link ( esc_html__ ( 'Older posts', 'view_source' ) ); ?></div>
          <?php endif; ?>

          <?php if ( get_previous_posts_link () ) : ?>
            <div class="nav-next"><?php previous_posts_link ( esc_html__ ( 'Newer posts', 'view_source' ) ); ?></div>
          <?php endif; ?>
